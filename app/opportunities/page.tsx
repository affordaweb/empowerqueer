    ...
    <main className="bg-white min-h-screen">
      ...
      <section className="bg-gradient-to-br from-[#F0EBF5] to-[#E8F4EC] pb-20 pt-[89px] px-4 border-b border-gray-100">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-[#474747] max-w-2xl mx-auto mb-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {externalResources.map((res) => (
              <a
                ...
                className="bg-white border border-gray-200 rounded-xl p-5 hover:border-[#A9D6B6] hover:shadow-sm transition-all group"
              >
