    ...
    <main className="bg-white min-h-screen">
      ...
      <section className="bg-gradient-to-br from-[#F0EBF5] to-[#E8F4EC] pb-[130px] min-h-[600px] pt-[164px] border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col justify-end">
          <div className="pb-8">
            <span className="inline-block bg-[#7C3AED]/10 text-[#7C3AED] text-xs font-bold px-4 py-1.5 rounded-full uppercase tracking-wider mb-4">Service Directory</span>
            <h1 className="font-serif text-5xl font-bold text-[#3A3C51] mb-4">Find LGBTQIA+ Services Near You</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-10">
              <span className="inline-block bg-[#7C3AED]/10 text-[#7C3AED] text-xs font-bold px-4 py-1.5 rounded-full uppercase tracking-wider mb-4">Community Directory</span>
              <h2 className="font-serif text-3xl font-bold text-[#3A3C51] mb-3">Submit a Service Listing</h2>
              <p className="text-[#474747] text-lg leading-relaxed">
                Know an LGBTQIA+-affirming clinic, support group, or organization that isn&apos;t listed here? Help us grow this directory.
              </p>
            </div>
