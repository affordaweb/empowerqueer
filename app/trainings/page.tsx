        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {programs.map((program) => (
              <div
                key={program.org}
                className="bg-white border border-gray-200 rounded-2xl p-8 hover:border-[#C2BED8] hover:shadow-md transition-all flex flex-col"
              >
                <div className="w-12 h-12 bg-[#C2BED8] rounded-xl flex items-center justify-center mb-6">
                  <BookOpen size={22} className="text-[#3D3558]" />
                </div>
                <h2 className="font-serif text-xl font-bold text-[#3D3558] mb-3">
                  {program.org}
                </h2>
                ...
                {/* Featured program */}
                <div className="bg-[#C2BED8]/10 border border-[#C2BED8] rounded-xl p-4 mb-6 flex-1">
                  <p className="text-[#3D3558] text-xs uppercase tracking-widest font-semibold mb-2">
                    Featured Program
                  </p>
                  <h3 className="font-semibold text-[#3D3558] mb-1">{program.featured.title}</h3>
                  <p className="text-[#52506A] text-sm">{program.featured.desc}</p>
                </div>
                ...
                <a
                  href="/contact/"
                  className="inline-flex items-center gap-1.5 text-[#3D3558] text-sm font-semibold hover:gap-2.5 transition-all"
                >
