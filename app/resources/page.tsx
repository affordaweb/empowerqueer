    ...
    <main className="bg-white min-h-screen">
      ...
      <section className="bg-gradient-to-br from-[#F0F7FF] to-[#DBEAFE] py-20 px-4 border-b border-gray-100">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="font-serif text-5xl font-bold text-[#1E3A5F] mb-4">Resources</h1>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-10">
            ...
            <div className="lg:col-span-3 space-y-6">
              ...
              {resources.map((res) => (
                ...
                >
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 bg-[#BFDBFE] rounded-lg flex items-center justify-center shrink-0 mt-0.5">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-[#374151] text-xs mb-3 font-medium">
                        Source: {res.org}
                      </p>
                      ...
                      <a
                        href="#"
                        className="inline-flex items-center gap-1.5 text-[#1E3A5F] text-sm font-semibold hover:underline"
                      >
              ...
              {/* Submit CTA */}
              <div className="bg-[#BFDBFE]/10 border border-[#BFDBFE] rounded-2xl p-8 text-center">
