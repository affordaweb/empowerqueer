      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <ul className="hidden lg:flex items-center gap-0.5">
            {navLinks.map((link) => (
              <li key={link.href}>
                <a
                  href={link.href}
                  className="text-[#374151] hover:text-[#1E3A5F] text-sm px-3 py-2 rounded-md hover:bg-[#BFDBFE]/30 transition-all"
                >
                  {link.label}
                </a>
              </li>
          ...
          <div className="flex items-center gap-3">
            <a
              href="/donate/"
              className="hidden sm:inline-flex items-center gap-1.5 bg-[#2563EB] text-white text-sm font-semibold px-4 py-2 rounded-full hover:bg-[#1D4ED8] transition-colors"
            >
              <Heart size={14} />
              Donate Now!
            </a>
            ...
            <ul className="py-2">
              {navLinks.map((link) => (
                <li key={link.href}>
                  <a
                    href={link.href}
                    className="block text-[#374151] hover:text-[#1E3A5F] hover:bg-[#BFDBFE]/20 px-5 py-3 text-sm transition-all"
              ...
              <li className="px-4 py-3">
                <a
                  href="/donate/"
                  className="block bg-[#2563EB] text-white text-sm font-semibold px-4 py-2 rounded-full text-center"
                >
...
function Hero() {
  return (
    <section className="bg-gradient-to-br from-[#F0F7FF] to-[#DBEAFE] py-24 px-4">
      <div className="max-w-4xl mx-auto text-center">
        <p className="font-serif text-2xl sm:text-3xl italic text-[#2563EB] mb-6">
          You Are Seen. You Are Valid. You Are Home.
        </p>
        <h1 className="font-serif text-4xl sm:text-5xl lg:text-6xl font-bold text-[#1E3A5F] leading-tight mb-6">
          Empower Queer Hub | LGBTQIA+ Support, Events &amp; Inclusive Resources
        </h1>
        <p className="max-w-2xl mx-auto text-[#374151] text-lg leading-relaxed mb-10">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <a
            href="/about/"
            className="bg-[#BFDBFE] text-[#1E3A5F] font-semibold px-8 py-3.5 rounded-full hover:bg-[#2563EB] hover:text-white transition-all text-base"
          >
            Learn More
          </a>
          <a
    ...
    <section className="py-20 bg-[#EFF6FF]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14">
          <p className="text-[#1E3A5F] font-semibold tracking-widest uppercase text-sm mb-3">
            What We Offer
          </p>
          <h2 className="font-serif text-4xl sm:text-5xl font-bold text-[#1E3A5F] mb-4">
            Everything You Need, In One Hub
          </h2>
          <p className="text-[#374151] max-w-xl mx-auto text-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {features.map((feat) => {
            ...
            return (
              <div
                key={feat.title}
                className="bg-white border border-gray-200 rounded-2xl p-8 hover:shadow-md hover:border-[#BFDBFE] transition-all duration-300 group"
              >
                <div className="w-14 h-14 bg-[#BFDBFE] rounded-xl flex items-center justify-center mb-6 group-hover:bg-[#2563EB] transition-colors">
                  <Icon size={26} className="text-[#1E3A5F] group-hover:text-white transition-colors" />
                </div>
                <h3 className="font-serif text-xl font-bold text-[#1E3A5F] mb-3">
                  {feat.title}
                </h3>
                ...
                <a
                  href={feat.href}
                  className="inline-flex items-center gap-1.5 text-[#1E3A5F] hover:text-[#1D4ED8] text-sm font-semibold transition-colors"
                >
    ...
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          {/* Podcast card */}
          <div className="bg-[#BFDBFE]/20 border border-[#BFDBFE] rounded-3xl p-10">
            <div className="w-16 h-16 bg-[#BFDBFE] rounded-2xl flex items-center justify-center mb-6">
            ...
            <a
              href="/kopisodes/"
              className="inline-flex items-center gap-2 bg-[#BFDBFE] text-[#1E3A5F] font-semibold px-6 py-3 rounded-full hover:bg-[#2563EB] hover:text-white transition-all text-sm"
            >
          ...
          <div>
            ...
            <h2 className="font-serif text-4xl sm:text-5xl font-bold text-[#1E3A5F] mb-6 leading-tight">
            ...
            <a
              href="/kopisodes/"
              className="inline-flex items-center gap-2 bg-[#BFDBFE] text-[#1E3A5F] font-semibold px-7 py-3 rounded-full hover:bg-[#2563EB] hover:text-white transition-all"
            >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <h2 className="font-serif text-4xl sm:text-5xl font-bold text-[#1E3A5F] mb-8 leading-tight">
            ...
            <div className="space-y-5">
              {pillars.map((p) => (
                ...
                >
                  <h4 className="font-semibold text-[#1E3A5F] mb-1">{p.title}</h4>
                  <p className="text-[#374151] text-sm leading-relaxed">{p.desc}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          {/* Wagayway box */}
          <div className="bg-white border border-[#BFDBFE] rounded-3xl p-8 shadow-sm">
  ...
  return (
    <section className="py-20 bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="mx-auto w-24 h-24 rounded-full overflow-hidden mb-8 border-4 border-[#BFDBFE]">
          {/* eslint-disable-next-line @next/next/no-img-element */}
        ...
        <blockquote className="font-serif text-lg sm:text-xl text-[#1E3A5F] leading-relaxed mb-8 italic text-left max-w-3xl mx-auto">
        ...
        <div className="mb-8">
          <p className="text-[#1E3A5F] font-bold text-lg">Aivan Castillo Alvarez</p>
          <p className="text-[#374151] text-sm">
        ...
        <div className="flex items-center justify-center gap-4 flex-wrap">
          <a
            ...
            className="flex items-center gap-2 text-[#374151] hover:text-[#1E3A5F] text-sm transition-colors bg-[#BFDBFE]/20 border border-[#BFDBFE] px-4 py-2 rounded-full hover:border-[#2563EB]"
          >
            <Mail size={15} />
            Email Aivan
          </a>
...
function Stats() {
  return (
    <section className="py-16 bg-[#EFF6FF]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white border border-[#BFDBFE] rounded-3xl px-8 py-12 shadow-sm">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {stats.map((stat) => {
              const Icon = stat.icon;
              return (
                <div key={stat.label} className="group">
                  <div className="w-12 h-12 bg-[#BFDBFE] rounded-xl flex items-center justify-center mx-auto mb-4 group-hover:bg-[#2563EB] transition-colors">
                    <Icon size={20} className="text-[#1E3A5F] group-hover:text-white transition-colors" />
                  </div>
                  <div className="font-serif text-4xl font-bold text-[#1E3A5F] mb-1">
                    {stat.value}
                  </div>
                  <div className="text-[#374151] text-sm font-medium">
                    {stat.label}
                  </div>
                </div>
              );
    ...
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <h2 className="font-serif text-4xl font-bold text-[#1E3A5F]">
            Our Moments
          </h2>
        </div>
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
          {galleryItems.map((item, i) => (
            <div
              key={i}
              className={`relative bg-[#BFDBFE]/20 border border-[#BFDBFE] rounded-xl overflow-hidden group hover:border-[#2563EB] hover:shadow-sm transition-all ${
    ...
    <section className="py-16 bg-[#EFF6FF]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10">
          <p className="text-[#1E3A5F] text-sm uppercase tracking-widest font-semibold">
        ...
        <div className="flex flex-wrap items-center justify-center gap-6 sm:gap-10">
          {sponsors.map((s) => (
            <div
              key={s.name}
              className="bg-white border border-gray-200 rounded-xl px-6 py-4 hover:border-[#BFDBFE] hover:bg-[#BFDBFE]/10 transition-all shadow-sm flex items-center justify-center"
            >
              {/* eslint-disable-next-line @next/next/no-img-element */}
    ...
    <footer className="bg-white border-t border-gray-200 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            <h4 className="font-semibold text-[#1E3A5F] text-sm mb-4 uppercase tracking-wider">Quick Links</h4>
            <ul className="space-y-2">
              {quickLinks.map((link) => (
                <li key={link.href}>
                  <a href={link.href} className="text-[#374151] hover:text-[#1E3A5F] text-sm transition-colors flex items-center gap-1.5 group">
          ...
          <div>
            <h4 className="font-semibold text-[#1E3A5F] text-sm mb-4 uppercase tracking-wider">Categories</h4>
            <ul className="space-y-2">
              {footerCategories.map((cat) => (
                <li key={cat.href}>
                  <a href={cat.href} className="text-[#374151] hover:text-[#1E3A5F] text-sm transition-colors flex items-center gap-1.5 group">
                    <ChevronRight size={12} className="opacity-0 group-hover:opacity-100 transition-opacity -ml-2 shrink-0" />
                    {cat.label}
                  </a>
                </li>
          ...
          <div>
            <h4 className="font-semibold text-[#1E3A5F] text-sm mb-4 uppercase tracking-wider">Recent Posts</h4>
            <ul className="space-y-4">
              {recentPosts.map((post) => (
                <li key={post.title}>
                  <a href={post.href} className="text-[#374151] hover:text-[#1E3A5F] text-sm transition-colors leading-relaxed block">
                    {post.title}
                  </a>
                </li>
              ))}
        ...
        <div className="border-t border-gray-200 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-[#374151] text-xs">© 2026 EmpowerQueer Hub. All rights reserved.</p>
          <div className="rainbow-bar h-[3px] w-16 rounded-full" />
          <p className="text-[#374151] text-xs">Batangas, Philippines · Founded 2018</p>
        </div>
      </div>
    </footer>
  );
