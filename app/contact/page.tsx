      ...
      <section className="py-16 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {/* Contact info */}
            <div>
              <h2 className="font-serif text-2xl font-bold text-[#1E3A5F] mb-6">
                Contact Information
              </h2>

              <div className="space-y-4 mb-8">
                <div className="flex items-start gap-4 bg-white border border-gray-200 rounded-xl p-4">
                  <div className="w-10 h-10 bg-[#BFDBFE] rounded-lg flex items-center justify-center shrink-0">
                    <MapPin size={18} className="text-[#1E3A5F]" />
                  </div>
                  <div>
                    <p className="font-semibold text-[#1E3A5F] text-sm mb-1">Address</p>
                ...
                <div className="flex items-center gap-4 bg-white border border-gray-200 rounded-xl p-4">
                  ...
                  <div>
                    <p className="font-semibold text-[#1E3A5F] text-sm mb-1">Phone</p>
                    <a href="tel:+639297414738" className="text-[#374151] text-sm hover:text-[#1E3A5F] transition-colors">
                      +63.929.741.4738
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4 bg-white border border-gray-200 rounded-xl p-4">
                  ...
                  <div>
                    <p className="font-semibold text-[#1E3A5F] text-sm mb-1">Email</p>
                    <a href="mailto:contact@empowerqueerhub.com" className="text-[#374151] text-sm hover:text-[#1E3A5F] transition-colors">
              ...
              <div className="bg-[#BFDBFE]/10 border border-[#BFDBFE] rounded-xl p-6">
                <h3 className="font-semibold text-[#1E3A5F] mb-3">Support, Trainings &amp; Collaboration Inquiries</h3>
                <p className="text-[#374151] text-sm mb-3">EmpowerQueer Hub also welcomes messages related to:</p>
                <ul className="space-y-2 text-[#374151] text-sm list-disc pl-4">
                ...
                <p className="text-[#374151] text-xs mt-4 italic">
              ...
              {submitted ? (
                <div className="bg-[#BFDBFE]/20 border border-[#BFDBFE] rounded-2xl p-10 text-center">
                  <div className="w-16 h-16 bg-[#BFDBFE] rounded-full flex items-center justify-center mx-auto mb-4">
                    <Mail size={28} className="text-[#1E3A5F]" />
                  </div>
      ...
      <section className="py-16 px-4 bg-[#EFF6FF]">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="font-serif text-3xl font-bold text-[#1E3A5F] mb-3">Frequently Asked Questions</h2>
            <p className="text-[#374151]">Quick answers to help you navigate the EmpowerQueer Hub with confidence.</p>
          </div>
          <div className="space-y-4">
            {[
              ...
              <div key={faq.q} className="bg-white border border-gray-200 rounded-xl p-6 hover:border-[#BFDBFE] transition-all">
