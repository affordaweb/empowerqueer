            ...
            <div>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start gap-4 bg-white border border-gray-200 rounded-xl p-4">
                  <div className="w-10 h-10 bg-[#B5C4AE] rounded-lg flex items-center justify-center shrink-0">
                ...
                <div className="flex items-center gap-4 bg-white border border-gray-200 rounded-xl p-4">
                  <div className="w-10 h-10 bg-[#B5C4AE] rounded-lg flex items-center justify-center shrink-0">
                    <Phone size={18} className="text-[#4A3F6B]" />
                  </div>
                  <div>
                ...
                <div className="flex items-center gap-4 bg-white border border-gray-200 rounded-xl p-4">
                  <div className="w-10 h-10 bg-[#B5C4AE] rounded-lg flex items-center justify-center shrink-0">
                    <Mail size={18} className="text-[#4A3F6B]" />
                  </div>
                  <div>
              ...
              {submitted ? (
                <div className="bg-[#B5C4AE]/20 border border-[#B5C4AE] rounded-2xl p-10 text-center">
                  <div className="w-16 h-16 bg-[#B5C4AE] rounded-full flex items-center justify-center mx-auto mb-4">
                    <Mail size={28} className="text-[#4A3F6B]" />
                  </div>
