            ...
            <div>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start gap-4 bg-white border border-gray-200 rounded-xl p-4">
                  <div className="w-10 h-10 bg-[#C2BED8] rounded-lg flex items-center justify-center shrink-0">
                    <MapPin size={18} className="text-[#3D3558]" />
                  </div>
                  <div>
                    <p className="font-semibold text-[#3D3558] text-sm mb-1">Address</p>
                    <p className="text-[#52506A] text-sm leading-relaxed">
                ...
                <div className="flex items-center gap-4 bg-white border border-gray-200 rounded-xl p-4">
                  <div className="w-10 h-10 bg-[#C2BED8] rounded-lg flex items-center justify-center shrink-0">
                    <Phone size={18} className="text-[#3D3558]" />
                  </div>
                  <div>
                    <p className="font-semibold text-[#3D3558] text-sm mb-1">Phone</p>
                    <a href="tel:+639297414738" className="text-[#52506A] text-sm hover:text-[#3D3558] transition-colors">
                      +63.929.741.4738
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4 bg-white border border-gray-200 rounded-xl p-4">
                  <div className="w-10 h-10 bg-[#C2BED8] rounded-lg flex items-center justify-center shrink-0">
                    <Mail size={18} className="text-[#3D3558]" />
                  </div>
                  <div>
                    <p className="font-semibold text-[#3D3558] text-sm mb-1">Email</p>
                    <a href="mailto:contact@empowerqueerhub.com" className="text-[#52506A] text-sm hover:text-[#3D3558] transition-colors">
              ...
              <div className="bg-[#C2BED8]/10 border border-[#C2BED8] rounded-xl p-6">
                <h3 className="font-semibold text-[#3D3558] mb-3">Support, Trainings &amp; Collaboration Inquiries</h3>
                <p className="text-[#52506A] text-sm mb-3">EmpowerQueer Hub also welcomes messages related to:</p>
                <ul className="space-y-2 text-[#52506A] text-sm list-disc pl-4">
                ...
                <p className="text-[#52506A] text-xs mt-4 italic">
              ...
              {submitted ? (
                <div className="bg-[#C2BED8]/20 border border-[#C2BED8] rounded-2xl p-10 text-center">
                  <div className="w-16 h-16 bg-[#C2BED8] rounded-full flex items-center justify-center mx-auto mb-4">
                    <Mail size={28} className="text-[#3D3558]" />
                  </div>
                  <h3 className="font-serif text-xl font-bold text-[#3D3558] mb-2">
                    Message Received
                  </h3>
      ...
      <section className="py-16 px-4 bg-[#F2EFF8]">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="font-serif text-3xl font-bold text-[#3D3558] mb-3">Frequently Asked Questions</h2>
            <p className="text-[#52506A]">Quick answers to help you navigate the EmpowerQueer Hub with confidence.</p>
          </div>
          <div className="space-y-4">
            {[
              ...
              <div key={faq.q} className="bg-white border border-gray-200 rounded-xl p-6 hover:border-[#C2BED8] transition-all">
                <h3 className="font-semibold text-[#3D3558] mb-2">{faq.q}</h3>
                <p className="text-[#52506A] text-sm leading-relaxed">{faq.a}</p>
              </div>
            ))}
          </div>
        </div>
