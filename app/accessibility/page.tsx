      ...
      <section className="py-16 px-4">
        <div className="max-w-3xl mx-auto space-y-10">
          ...
          <div>
            ...
            <p className="text-[#4E5A4A] leading-relaxed">
          ...
          <div>
            ...
            <ul className="space-y-2 text-[#4E5A4A] text-sm list-disc pl-5">
            ...
            <p className="text-[#4E5A4A] leading-relaxed mt-4">
          ...
          <div>
            ...
            <p className="text-[#4E5A4A] leading-relaxed mt-3">
          ...
          <div className="bg-[#EFF3EC] border border-[#B5C4AE] rounded-2xl p-8">
            <h2 className="font-serif text-2xl font-bold text-[#4A3F6B] mb-4">Feedback &amp; Support</h2>
            <p className="text-[#4E5A4A] leading-relaxed mb-3">
            ...
            <p className="text-[#4E5A4A] text-sm mt-4">
          ...
          <div className="border-t border-gray-200 pt-8">
            <p className="text-[#4E5A4A] text-sm mb-4"><strong>Last Updated:</strong> June 2025</p>
            <p className="text-[#4E5A4A] leading-relaxed text-sm italic">
