    ...
    <main className="bg-white min-h-screen">
      ...
      <section className="bg-gradient-to-br from-[#F5F2FA] to-[#E8E2F5] py-20 px-4 border-b border-gray-100">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="font-serif text-5xl font-bold text-[#3D3558] mb-4">Accessibility Statement</h1>
      ...
      <section className="py-16 px-4">
        <div className="max-w-3xl mx-auto space-y-10">
          ...
          <div>
            <h2 className="font-serif text-2xl font-bold text-[#3D3558] mb-4">EmpowerQueer Hub is for Everyone</h2>
            <p className="text-[#52506A] leading-relaxed">
          ...
          <div>
            <h2 className="font-serif text-2xl font-bold text-[#3D3558] mb-4">Accessibility Features We Use</h2>
            ...
            <ul className="space-y-2 text-[#52506A] text-sm list-disc pl-5">
            ...
            <p className="text-[#52506A] leading-relaxed mt-4">
          ...
          <div>
            <h2 className="font-serif text-2xl font-bold text-[#3D3558] mb-4">Design Considerations</h2>
            <p className="text-[#52506A] leading-relaxed mb-4">
          ...
          <div>
            <h2 className="font-serif text-2xl font-bold text-[#3D3558] mb-4">Ongoing Improvements</h2>
            <p className="text-[#52506A] leading-relaxed">
            ...
            <p className="text-[#52506A] leading-relaxed mt-3">
          ...
          <div className="bg-[#F2EFF8] border border-[#C2BED8] rounded-2xl p-8">
            <h2 className="font-serif text-2xl font-bold text-[#3D3558] mb-4">Feedback &amp; Support</h2>
            <p className="text-[#52506A] leading-relaxed mb-3">
              If you encounter an accessibility issue or have suggestions for improvement, please reach out to us:
            </p>
            <ul className="space-y-2 text-[#52506A] text-sm list-disc pl-5">
              <li>Email: <a href="mailto:support@empowerqueerhub.org" className="text-[#3D3558] hover:underline font-medium">support@empowerqueerhub.org</a></li>
              <li>Or use our <a href="/contact/" className="text-[#3D3558] hover:underline font-medium">Contact Us</a> page to submit your feedback.</li>
            </ul>
            <p className="text-[#52506A] text-sm mt-4">
              We aim to respond to all accessibility-related messages within 3–5 business days.
            </p>
          </div>

          <div>
            <h2 className="font-serif text-2xl font-bold text-[#3D3558] mb-4">Third-Party Tools &amp; Content</h2>
            <p className="text-[#52506A] leading-relaxed">
          ...
          <div className="border-t border-gray-200 pt-8">
            <p className="text-[#52506A] text-sm mb-4"><strong>Last Updated:</strong> June 2025</p>
            <p className="text-[#52506A] leading-relaxed text-sm italic">
