    ...
    <main className="bg-white min-h-screen">
      ...
      <section className="bg-gradient-to-br from-[#EDE8F5] to-[#E4EDE0] py-20 px-4 border-b border-gray-100">
        <div className="max-w-4xl mx-auto text-center">
          <div className="w-16 h-16 bg-[#B5C4AE] rounded-2xl flex items-center justify-center mx-auto mb-6">
            <Heart size={30} className="text-[#4A3F6B]" />
          </div>
          <h1 className="font-serif text-5xl font-bold text-[#4A3F6B] mb-4">Donate</h1>
      ...
      <section className="py-16 px-4">
        <div className="max-w-3xl mx-auto">
          <h2 className="font-serif text-3xl font-bold text-[#4A3F6B] mb-6">Support the Movement.</h2>
          ...
          <p className="font-serif text-lg italic text-[#4A3F6B] mb-10">
            Fuel the change you believe in.
          </p>

          {/* Bank Details */}
          <div className="bg-[#EEEAF5] border border-[#B5C4AE] rounded-2xl p-8 mb-8">
            <h3 className="font-serif text-xl font-bold text-[#4A3F6B] mb-6">Bank Deposit</h3>
            <div className="space-y-4">
              {[
                ...
                <div key={item.label} className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-4 border-b border-[#B5C4AE]/50 pb-3 last:border-0 last:pb-0">
                  <span className="text-[#4A3F6B] font-semibold text-sm w-40 shrink-0">{item.label}</span>
                  <span className="text-[#5C576E] text-sm">{item.value}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          {/* GoGetFunding */}
          <div className="bg-white border border-gray-200 rounded-2xl p-8 text-center hover:border-[#B5C4AE] transition-all">
            <h3 className="font-serif text-xl font-bold text-[#4A3F6B] mb-3">Go Get Funding</h3>
            <p className="text-[#5C576E] text-sm mb-5">
