    ...
    <main className="bg-white min-h-screen">
      ...
      <section className="py-16 px-4">
        <div className="max-w-3xl mx-auto">
          ...
          {/* Bank Details */}
          <div className="bg-[#EFF3EC] border border-[#B5C4AE] rounded-2xl p-8 mb-8">
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={item.label} className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-4 border-b border-[#B5C4AE]/50 pb-3 last:border-0 last:pb-0">
                  ...
                  <span className="text-[#4E5A4A] text-sm">{item.value}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-8 text-center hover:border-[#B5C4AE] transition-all">
            ...
            <p className="text-[#4E5A4A] text-sm mb-5">
