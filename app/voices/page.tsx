    ...
    <main className="bg-white min-h-screen">
      ...
      <section className="bg-gradient-to-br from-[#FDF8EE] to-[#F5E6CE] py-20 px-4 border-b border-gray-100">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="font-serif text-5xl font-bold text-[#5C3D2E] mb-4">Voices Among Us</h1>
          ...
          {submitted ? (
            <div className="bg-[#E8D5B0]/20 border border-[#E8D5B0] rounded-2xl p-10 text-center">
              <div className="w-16 h-16 bg-[#E8D5B0] rounded-full flex items-center justify-center mx-auto mb-4">
                <Mic2 size={28} className="text-[#5C3D2E]" />
              </div>
              <h3 className="font-serif text-xl font-bold text-[#5C3D2E] mb-2">Story Received</h3>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <div className="border-2 border-dashed border-[#E8D5B0] rounded-xl p-6 text-center hover:border-[#C4784C] transition-colors">
                  <p className="text-[#5C4A3A] text-sm mb-2">No image selected</p>
                  <input type="file" accept="image/*" className="hidden" id="voice-image" />
                  <label
                    htmlFor="voice-image"
                    className="inline-block bg-[#E8D5B0] text-[#5C3D2E] text-sm font-semibold px-5 py-2 rounded-full cursor-pointer hover:bg-[#C4784C] hover:text-white transition-all"
                  >
                    Add Image
                  </label>
                </div>
