    ...
    <main className="bg-white min-h-screen">
      ...
      <section className="bg-gradient-to-br from-[#F0F7FF] to-[#DBEAFE] py-20 px-4 border-b border-gray-100">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-[#2563EB] font-semibold text-sm uppercase tracking-widest mb-3">Category</p>
          <h1 className="font-serif text-5xl font-bold text-[#1E3A5F] mb-4">Support Resources</h1>
            ...
            >
              <div className="flex flex-col sm:flex-row">
                ...
                <div className="flex-1 p-6">
                  <p className="text-[#374151] text-xs mb-2">{post.date}</p>
                  <h3 className="font-serif text-lg font-bold text-[#1E3A5F] mb-2">{post.title}</h3>
                  <p className="text-[#374151] text-sm leading-relaxed mb-3">{post.desc}</p>
                  <a href="/kopisodes/" className="inline-flex items-center gap-1.5 text-[#1E3A5F] text-sm font-semibold hover:gap-2.5 transition-all">
