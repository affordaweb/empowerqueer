    ...
    <main className="bg-white min-h-screen">
      ...
      <section className="bg-gradient-to-br from-[#F5F2FA] to-[#E8E2F5] py-20 px-4 border-b border-gray-100">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="font-serif text-5xl font-bold text-[#3D3558] mb-4">Kopisodes</h1>
          <p className="text-[#52506A] text-xl font-medium mb-3">Stories That Speak Truth</p>
          <p className="text-[#52506A] max-w-2xl mx-auto leading-relaxed">
      ...
      <section className="py-16 px-4 bg-[#C2BED8]/10">
        <div className="max-w-4xl mx-auto">
          <div className="bg-white border border-[#C2BED8] rounded-2xl p-8">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            {episodes.map((ep) => (
              <div
                key={ep.title}
                className="bg-white border border-gray-200 rounded-2xl overflow-hidden hover:border-[#C2BED8] hover:shadow-sm transition-all group"
              >
                <div className="flex flex-col sm:flex-row">
                  ...
                  <div className="flex-1 p-6">
                    ...
                    <h3 className="font-serif text-lg font-bold text-[#3D3558] mb-2">
                      {ep.title}
                    </h3>
