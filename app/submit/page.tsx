        ...
        <div className="max-w-3xl mx-auto">
          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <label className="block text-[#4A3F6B] text-sm font-medium mb-2">
                  Category / Tags
                </label>
              ...
              <div>
                ...
                <div className="border-2 border-dashed border-[#B5C4AE] rounded-xl p-6 text-center hover:border-[#6B8F63] transition-colors">
                  ...
                  <label
                    htmlFor="file-upload"
                    className="inline-block bg-[#B5C4AE] text-[#4A3F6B] text-sm font-semibold px-5 py-2 rounded-full cursor-pointer hover:bg-[#6B8F63] hover:text-white transition-all mt-1"
                  >
                    Choose File
                  </label>
                </div>
