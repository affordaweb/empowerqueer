      ...
      <section className="bg-gradient-to-br from-[#F0F7FF] to-[#DBEAFE] py-20 px-4 border-b border-gray-100">
        <div className="max-w-4xl mx-auto text-center">
          <div className="w-16 h-16 bg-[#BFDBFE] rounded-2xl flex items-center justify-center mx-auto mb-6">
            <Upload size={30} className="text-[#1E3A5F]" />
          </div>
          ...
          {submitted ? (
            <div className="bg-[#BFDBFE]/20 border border-[#BFDBFE] rounded-2xl p-10 text-center">
              <div className="w-16 h-16 bg-[#BFDBFE] rounded-full flex items-center justify-center mx-auto mb-4">
                <Upload size={28} className="text-[#1E3A5F]" />
              </div>
              <h3 className="font-serif text-xl font-bold text-[#1E3A5F] mb-2">Submission Received</h3>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                  {["Mental Health", "HIV Awareness", "Legal Aid", "Economic Inclusion", "Youth-Focused", "Trans/Nonbinary", "Disability Inclusion", "General Support"].map((tag) => (
                    <label key={tag} className="flex items-center gap-2 text-[#374151] text-sm cursor-pointer">
                      <input type="checkbox" className="rounded border-gray-300 text-[#2563EB] focus:ring-[#BFDBFE]" />
                      {tag}
                    </label>
                  ))}
                </div>
              ...
              <div>
                ...
                <div className="border-2 border-dashed border-[#BFDBFE] rounded-xl p-6 text-center hover:border-[#2563EB] transition-colors">
                  <Upload size={24} className="text-[#1E3A5F] mx-auto mb-2" />
                  <p className="text-[#374151] text-sm mb-1">DOC or PDF only</p>
                  <input type="file" accept=".doc,.docx,.pdf" className="hidden" id="file-upload" />
                  <label
                    htmlFor="file-upload"
                    className="inline-block bg-[#BFDBFE] text-[#1E3A5F] text-sm font-semibold px-5 py-2 rounded-full cursor-pointer hover:bg-[#2563EB] hover:text-white transition-all mt-1"
                  >
                    Choose File
                  </label>
                </div>
              ...
              {submissionType === "event" && (
                <div className="bg-[#EFF6FF] border border-[#BFDBFE] rounded-xl p-6 space-y-4">
                  <h3 className="font-semibold text-[#1E3A5F] text-sm">Event-Specific Details</h3>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-[#1E3A5F] text-sm font-medium mb-1.5">Event Date <span className="text-red-400">*</span></label>
                      <input type="date" className="w-full border border-gray-200 rounded-xl px-4 py-3 text-[#374151] text-sm focus:outline-none focus:border-[#BFDBFE] focus:ring-2 focus:ring-[#BFDBFE]/40 transition-all" />
                    </div>
                    <div>
                      <label className="block text-[#1E3A5F] text-sm font-medium mb-1.5">Event Time <span className="text-red-400">*</span></label>
                      <input type="time" className="w-full border border-gray-200 rounded-xl px-4 py-3 text-[#374151] text-sm focus:outline-none focus:border-[#BFDBFE] focus:ring-2 focus:ring-[#BFDBFE]/40 transition-all" />
                    </div>
                  </div>
                  <div>
                    <label className="block text-[#1E3A5F] text-sm font-medium mb-1.5">Location / Platform <span className="text-red-400">*</span></label>
                    <input type="text" placeholder="Venue address or online platform" className="w-full border border-gray-200 rounded-xl px-4 py-3 text-[#374151] text-sm focus:outline-none focus:border-[#BFDBFE] focus:ring-2 focus:ring-[#BFDBFE]/40 transition-all" />
                  </div>
                  <div>
                    <label className="block text-[#1E3A5F] text-sm font-medium mb-1.5">Registration Link or Contact Info</label>
                    <input type="text" placeholder="Link or contact details" className="w-full border border-gray-200 rounded-xl px-4 py-3 text-[#374151] text-sm focus:outline-none focus:border-[#BFDBFE] focus:ring-2 focus:ring-[#BFDBFE]/40 transition-all" />
                  </div>
                </div>
              )}
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-4">
                  {["Full Name", "Nickname", "Anonymous"].map((opt) => (
                    <label key={opt} className="flex items-center gap-2 text-[#374151] text-sm cursor-pointer">
                      <input type="radio" name="credit" value={opt} className="text-[#2563EB] focus:ring-[#BFDBFE]" />
                      {opt}
                    </label>
                  ))}
                </div>
              ...
              <div className="flex items-start gap-3">
                <input
                  ...
                  required
                  id="consent"
                  className="mt-0.5 rounded border-gray-300 text-[#2563EB] focus:ring-[#BFDBFE]"
                />
                <label htmlFor="consent" className="text-[#374151] text-sm leading-relaxed">
