...
export default function AboutPage() {
  return (
    <main className="bg-white min-h-screen">
      ...
      {/* Hero */}
      <section className="relative min-h-[600px] flex items-end px-4 pt-[144px] pb-[50px] overflow-hidden">
        {/* Background image */}
        <div
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-10 w-full">
          <span className="inline-block bg-white/15 border border-white/25 text-[#A78BFA] text-xs font-bold px-4 py-1.5 rounded-full uppercase tracking-wider mb-5">Our Story</span>
          <h1 className="font-serif text-5xl lg:text-6xl font-bold text-white mb-5 drop-shadow-lg">
            About the Hub
          </h1>
