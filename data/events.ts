...
export const ALL_EVENTS: Event[] = [
  ...
  {
    id: "bisexual-visibility-day-2026",
    title: "Bisexual Visibility Day 2026",
    dateISO: "2026-09-23",
    dateDisplay: "September 23, 2026",
    time: "All day",
    location: "Online observance",
    description: "Wagayway Equality celebrates bisexual stories and identities and calls on the community to keep every bisexual person visible, valid, and valued.",
    category: "Cultural",
    tags: ["Bisexual Visibility", "Wagayway Equality", "Community", "LGBTQIA+"],
    image: "/images/events/bisexual-visibility-day-2026.jpg",
    link: "https://www.facebook.com/wagaywayequality/posts/pfbid035LuvrEVxpiFwwcgw5E2GBHNNLW9EbofGwMXSMY1cBnwGRrrRLo6shujXKn6XkXjal",
    featured: true,
  },
  {
