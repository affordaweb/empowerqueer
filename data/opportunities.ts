...
export const ALL_OPPORTUNITIES: Opportunity[] = [
  ...
  {
    id: "job-11",
    title: "Individual Giving & Corporate Support Specialist",
    org: "ILGA World",
    category: "jobs",
    description: "ILGA World is seeking an Individual Giving and Corporate Support Specialist to enhance support from individual donors and values-aligned corporate supporters. Remote, part-time (50%, 20.25 hours/week), 18-month contract. Responsibilities include developing supporter campaigns, growing monthly giving programs, donor stewardship, and corporate partnership cultivation. Salary range: 28,371–40,530 CHF per annum (pro-rated).",
    location: "Remote (Global)",
    deadline: "July 10, 2026",
    link: "https://yuthaxis.com/2026/07/09/ilga-world/",
    tags: ["ILGA World", "Fundraising", "Remote", "Part-time"],
    featured: true,
  },
  {
    id: "scholar-13",
    title: "UPCWGS Research Grant on Women and Gender",
    org: "UP Center for Women's and Gender Studies",
    category: "scholarships",
    description: "The UPCWGS Research Grant supports innovative research on women and gender in the Philippines. Awards up to PhP 100,000 each to four selected research projects. Projects must begin January 1, 2027 and be completed within nine months, producing a journal article and policy brief. Open to UP faculty and researchers.",
    location: "Philippines (UP System)",
    deadline: "July 31, 2026",
    link: "https://www2.fundsforngos.org/innovation/call-for-proposals-upcwgs-research-grant-program-philippines/",
    tags: ["Research", "Gender Studies", "UP", "Grant", "Philippines"],
    featured: true,
  },
];
