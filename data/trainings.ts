...
export const ALL_TRAININGS: Training[] = [
  ...
  {
    id: "ph-5",
    title: "HIV Counseling and Testing (HCT) Public Training — Q3–Q4 2026",
    org: "CAMP Pag-ayo, Inc.",
    category: "hiv-sexual-health",
    description: "CAMP Pag-ayo's self-funded public HCT training for medical and non-medical professionals, advocates, and key-population support workers. The current confirmed batches run September 21–25, October 21–25, and November 9–13, 2026 at Jade Hotel and Suites in Makati City. Registration details and fees are published by CAMP.",
    format: "In-Person",
    duration: "5 days",
    cost: "Paid (Self-funded public training)",
    link: "https://forms.gle/s2VQoWEPXmjrZbq96",
    tags: ["Philippines", "HIV", "Counseling", "Makati", "2026"],
    featured: true,
  },
  {
    id: "ph-6",
